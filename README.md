...
const bethel = {
    pronouns: "He" | "Him",
    location: "Ghana 🇬🇭",
    currentFocus: "React + TypeScript Systems",
    learning: ["AI Integration", "Advanced Web3", "System Design"],
    interests: ["Graphic Design", "Video Editing", "Innovation"],
    funFact: "I hate debugging my own code 🤣",
    lifePhilosophy: "Code with passion, design with purpose",
    currentlyBuilding: "Next-gen web applications",
    ...
    workingOn: () => {
        return "Building innovative solutions with React & TypeScript";
    }
};
```
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/Bethel-Fiagbetor)
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/Be_thelllll)
